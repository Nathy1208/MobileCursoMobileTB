...
class CineRegistro extends StatefulWidget {
  const CineRegistro({super.key});

  @override
  State<CineRegistro> createState() => _CineRegistroState();
}

class _CineRegistroState extends State<CineRegistro> {
  //atributos
